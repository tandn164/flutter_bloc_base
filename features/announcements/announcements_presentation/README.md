# announcements_presentation

The presentation package for the announcements feature. See [feature usage](../README.md)
for the complete architecture and app wiring instructions.

## Dependency injection

This package owns `lib/di/announcements_presentation_di.dart`. Injectable generates the
