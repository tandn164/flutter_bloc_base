...
The data package for the announcements feature. See [feature usage](../README.md)
for the complete architecture and app wiring instructions.

## Dependency injection

This package owns `lib/di/announcements_data_di.dart`. Injectable generates the
