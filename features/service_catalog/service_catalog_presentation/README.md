# service_catalog_presentation

The presentation package for the service_catalog feature. See [feature usage](../README.md)
for the complete architecture and app wiring instructions.

## Dependency injection

This package owns `lib/di/service_catalog_presentation_di.dart`. Injectable generates the
