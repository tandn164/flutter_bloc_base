# work_orders_presentation

The presentation package for the work_orders feature. See [feature usage](../README.md)
for the complete architecture and app wiring instructions.

## Dependency injection

This package owns `lib/di/work_orders_presentation_di.dart`. Injectable generates the
